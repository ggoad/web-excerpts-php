<?php 
require_once(__DIR__.'/stringConstruction.php');
...
function HTML_elementOb($ob){
	$arr=[$ob['tag']];
	if(isset($ob['properties'])){array_push($arr,$ob['properties']);}
	if(isset($ob['children'])){array_push($arr,$ob['children']);}
	if(isset($ob['raw'])){array_push($arr,$ob['raw']);}
	return HTML_element(...$arr);
}
