...
<title>Demo Greg Goad Dot Net Admin Login</title>

<meta name="description" content="Demo Greg Goad Dot Net Admin Login Interface"/>
<meta property="og:description" content="Demo Greg Goad Dot Net Admin Login Interface"/>
<meta property="og:title" content="Demo Greg Goad Dot Net Admin Login"/>
...
function SubmitIt(form){
	...
	ElFetch(waitDiv, 
		_el.CREATE('div','','',{},[_el.CREATE('span','SpinLeft','',{},["X"]), " Sending Form ", _el.CREATE('span','SpinRight','',{},["X"])]), 
		"getLogin.php", {method:"POST", body:fd},"text",{
			success:function(){
			...
			overrideMsg:"The username or password did not match."
		}
	);
...
<body>
<h1>Demo Greg Goad Dot Net Login</h1>

<form onsubmit="_el.CancelEvent(event); SubmitIt(this);">
<label>
Email
<br>
...
<input type="button" value="Show Password" onclick="var el=Array.from(this.previousElementSibling.querySelectorAll('input')).pop(); if(el.type === 'password'){return (el.type = 'text') && (this.value='Hide Password');} el.type='password'; this.value='Show Password'" />
<br><br><br>
<button>Submit</button>

<div><a href="generatePasswordRecovery.php"><div id="forgotPasswordLink">Forgot Your Password?</div></a></div>
</form>
<div id="waitDiv"></div>
</body>
</html>